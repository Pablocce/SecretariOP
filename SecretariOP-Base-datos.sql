...
-- Volcando estructura de base de datos para aplicacion
CREATE DATABASE IF NOT EXISTS `aplicacion` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `aplicacion`;

-- Volcando estructura para tabla aplicacion.empleados
CREATE TABLE IF NOT EXISTS `empleados` (
  `usuario` varchar(50) NOT NULL DEFAULT '0',
  `codigo_trabajador` int(11) NOT NULL DEFAULT 0,
  `nombre` varchar(50) NOT NULL DEFAULT '',
  `apellido` varchar(50) NOT NULL DEFAULT '',
  `puesto` varchar(50) NOT NULL DEFAULT '',
  `sueldo` float NOT NULL DEFAULT 0,
  KEY `codigo_trabajador` (`codigo_trabajador`),
  KEY `usuario_trabajador` (`usuario`),
  CONSTRAINT `usuario_trabajador` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`nombre_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla aplicacion.notas
CREATE TABLE IF NOT EXISTS `notas` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `usuario` (`usuario`),
  CONSTRAINT `usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`nombre_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla aplicacion.productos
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `usuario_producto` (`usuario`),
  CONSTRAINT `usuario_producto` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`nombre_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla aplicacion.usuarios
...
-- Volcando estructura de base de datos para phpmyadmin
